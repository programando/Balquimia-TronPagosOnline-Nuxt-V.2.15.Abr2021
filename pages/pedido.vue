    ...
    <div class="flex items-center justify-center mt-8 md:mt-14">
      <div class="px-10 py-4 border border-primary">
        <div class="pb-4 text-lg sm:text-xl lg:text-2xl text-primary ">
          <h1 class="text-center">Pago con número de pedido</h1>
        </div>
        ...
        <div class="flex justify-center mt-4">
          ...
          <div v-if="mostrarBuscar" class="ml-2">       
            <button class="px-2 py-1 text-white border rounded-lg w-28 bg-primary border-primary" @click.prevent="buscarPedido  ">
              Buscar
            </button>
          </div>
  ...
  data: ()=>  ({
    ...
    methods: {
          buscarPedido() {
              ...
              .then( response => {
                  if (!response.data || response.data.length == 0) {
                    this.Message('Error!','Número de pedido no registrado.','error' );
                    return ;
                  }
          ...
          psePay() {
            ...
            this.PayuLatamSendForm( this.formUser, 'PED'+this.id_ped, this.signatureMD5() );     // It's a mixin
         ...
         signatureMD5( ) {
            ...
            return md5( signature);         
             ...
             dataValidation() {
               ...
               let getError = this.formValidate ( this.formUser, this.id_ped );
              return getError;
         },
